    ...
    try {
      const response = await fetch('/api/tags', {
        ...
        body: JSON.stringify({
          ...
          category_id: parseInt(newTagData.category_id),
          sub_category_id: newTagData.sub_category_id ? parseInt(newTagData.sub_category_id) : null
        })
      })
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <select
                  ...
                  onChange={(e) => setNewTagData(prev => ({ ...prev, category_id: e.target.value, sub_category_id: '' }))}
